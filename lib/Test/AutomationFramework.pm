...
#todo: 	* Need to copy the AUT to new server
#	** use tsProperty.txt to update 
#	* TS titleName
#	* TC directory 
#Note: ts;list will update all index.html
#
####################
# * Number of TS execution
# * 24 exec,  					done
...
EOF
	...
	my $tmp9 = sprintf("<a href=\"${url}/$SvrProjName/$reportHtmlSummary\" title=\"Click to display TC Summary\">");
...
${tmp9A}L</a>$passFailDisplay            <a title=\"Click Testcase Desc to view TC logs\">$strTmp</a>          -${tmp3}Pass</a>${tmp31}${tmp2}Fail</a>-  <a title=\"pass/fail counts\">${tmp1}Counters</a>  ${tmp7}Exec T</a> ${tmp6}         <a title=\"Manual command to exec TC\">   ${tmp4}  </span>
EOF
